...
private:
  ...
  void GenerateParseJsonForField(Class &cls, CodeBlock &codeBlock, const ClassField &field, const std::string &varName);
  void GenerateParseJsonForFunction(Class &cls, CodeBlock &codeBlock, const ClassMethod &luaFunction);
  bool IsVariantTypeField(const Class &cls, const ClassField &field, const std::string **rawName = nullptr);
  ...
  void GenerateParseJsonVariant(Class &cls, CodeBlock &codeBlock, const ClassField &field, const std::string &varName);
};
} // namespace holgen

...
int TestStructArray::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = TestStructArray::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling TestStructArray.operator== method with an invalid lua proxy object!");
  TestStructArray arg0Mirror;
  TestStructArray *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = TestStructArray::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = TestStructArray::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void TestStructArray::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, TestStructArray::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);

...
DamageMultiplier *DamageMultiplier::ReadProxyFromLua(lua_State *luaState, int32_t idx) {
  ...
  lua_pop(luaState, 1);
  HOLGEN_WARN_AND_RETURN_IF(className != CLASS_NAME, nullptr, "Received {} instance when expecting DamageMultiplier", className);
  lua_pushstring(luaState, "p");
  lua_gettable(luaState, idx - 1);
...
int DamageMultiplier::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = DamageMultiplier::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling DamageMultiplier.operator== method with an invalid lua proxy object!");
  DamageMultiplier arg0Mirror;
  DamageMultiplier *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = DamageMultiplier::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = DamageMultiplier::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void DamageMultiplier::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, DamageMultiplier::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);

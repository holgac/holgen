...
bool TestStructArrayType::ParseJson(const rapidjson::Value &json, const Converter &converter, lua_State *luaState) {
  if (json.IsString()) {
...
rapidjson::Value TestStructArrayType::DumpJson(rapidjson::Document &doc, lua_State *luaState) const {

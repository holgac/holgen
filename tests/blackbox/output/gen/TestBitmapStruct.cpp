...
TestBitmapStruct *TestBitmapStruct::ReadProxyFromLua(lua_State *luaState, int32_t idx) {
  ...
  lua_pop(luaState, 1);
  HOLGEN_WARN_AND_RETURN_IF(className != CLASS_NAME, nullptr, "Received {} instance when expecting TestBitmapStruct", className);
  lua_pushstring(luaState, "p");
  lua_gettable(luaState, idx - 1);
...
int TestBitmapStruct::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = TestBitmapStruct::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling TestBitmapStruct.operator== method with an invalid lua proxy object!");
  TestBitmapStruct arg0Mirror;
  TestBitmapStruct *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = TestBitmapStruct::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = TestBitmapStruct::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void TestBitmapStruct::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, TestBitmapStruct::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);

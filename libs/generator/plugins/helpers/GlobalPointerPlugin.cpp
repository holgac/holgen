...
void GlobalPointerPlugin::GenerateInstanceField(Class &cls) const {
  auto field = ClassField{"mInstance", Type{"T", PassByType::Pointer}, Visibility::Private,
...
void GlobalPointerPlugin::GenerateGetInstance(Class &cls) const {
  auto method = ClassMethod{St::GlobalPointer_GetInstance, Type{"T", PassByType::Pointer},
...
void GlobalPointerPlugin::GenerateSetInstance(Class &cls) const {
  auto method = ClassMethod{St::GlobalPointer_SetInstance, Type{"void"}, Visibility::Public,

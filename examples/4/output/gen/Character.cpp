...
void Character::PushMirrorToLua(lua_State *luaState) const {
  ...
  LuaHelper::Push(mPartnerId, luaState);
  lua_settable(luaState, -3);
  lua_pushstring(luaState, "weapon");
  LuaHelper::Push(mWeaponId, luaState);
  lua_settable(luaState, -3);
...
int Character::IndexMetaMethod(lua_State *luaState) {
  ...
  if (0 == strcmp("id", key)) {
    ...
    LuaHelper::Push(instance->mPartnerId, luaState);
  } else if (0 == strcmp("partner", key)) {
    LuaHelper::Push(Character::Get(instance->mPartnerId), luaState);
  } else if (0 == strcmp("weaponId", key)) {
    LuaHelper::Push(instance->mWeaponId, luaState);
  } else if (0 == strcmp("weapon", key)) {
    LuaHelper::Push(Weapon::Get(instance->mWeaponId), luaState);
  } else if (0 == strcmp("armor", key)) {

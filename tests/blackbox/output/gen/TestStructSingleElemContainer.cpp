...
int TestStructSingleElemContainer::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = TestStructSingleElemContainer::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling TestStructSingleElemContainer.operator== method with an invalid lua proxy object!");
  TestStructSingleElemContainer arg0Mirror;
  TestStructSingleElemContainer *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = TestStructSingleElemContainer::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = TestStructSingleElemContainer::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void TestStructSingleElemContainer::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, TestStructSingleElemContainer::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);

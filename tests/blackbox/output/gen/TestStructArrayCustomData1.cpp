...
bool TestStructArrayCustomData1::ParseJson(const rapidjson::Value &json, const Converter &converter, lua_State *luaState) {
  if (json.IsObject()) {
...
rapidjson::Value TestStructArrayCustomData1::DumpJson(rapidjson::Document &doc, lua_State *luaState) const {
...
int TestStructArrayCustomData1::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = TestStructArrayCustomData1::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling TestStructArrayCustomData1.operator== method with an invalid lua proxy object!");
  TestStructArrayCustomData1 arg0Mirror;
  TestStructArrayCustomData1 *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = TestStructArrayCustomData1::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = TestStructArrayCustomData1::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void TestStructArrayCustomData1::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, TestStructArrayCustomData1::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);

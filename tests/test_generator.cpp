...
add_library(generator_test_cmake gen/Person.cpp gen/Converter.cpp gen/JsonHelper.cpp gen/LuaHelper.cpp gen/GlobalPointer.cpp gen/FilesystemHelper.cpp)
)R"
        }
    );
    // TODO: test helpers

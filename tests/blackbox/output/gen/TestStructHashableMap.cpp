...
int TestStructHashableMap::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = TestStructHashableMap::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling TestStructHashableMap.operator== method with an invalid lua proxy object!");
  TestStructHashableMap arg0Mirror;
  TestStructHashableMap *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = TestStructHashableMap::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = TestStructHashableMap::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void TestStructHashableMap::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, TestStructHashableMap::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);

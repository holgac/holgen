...
int TestContainerInnerStructWithId::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = TestContainerInnerStructWithId::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling TestContainerInnerStructWithId.operator== method with an invalid lua proxy object!");
  TestContainerInnerStructWithId arg0Mirror;
  TestContainerInnerStructWithId *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = TestContainerInnerStructWithId::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = TestContainerInnerStructWithId::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void TestContainerInnerStructWithId::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, TestContainerInnerStructWithId::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);

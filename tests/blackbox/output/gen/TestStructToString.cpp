...
bool TestStructToString::ParseJson(const rapidjson::Value &json, const Converter &converter, lua_State *luaState) {
  if (json.IsObject()) {
...
rapidjson::Value TestStructToString::DumpJson(rapidjson::Document &doc, lua_State *luaState) const {
...
int TestStructToString::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = TestStructToString::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling TestStructToString.operator== method with an invalid lua proxy object!");
  TestStructToString arg0Mirror;
  TestStructToString *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = TestStructToString::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = TestStructToString::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void TestStructToString::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, TestStructToString::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);

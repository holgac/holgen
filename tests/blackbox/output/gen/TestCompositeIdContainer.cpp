...
TestCompositeIdHuman *TestCompositeIdContainer::AddHuman(TestCompositeIdHuman &&elem) {
  ...
  if (mHumansNextDeletedIndex > 0) {
    ...
    HOLGEN_FAIL_IF(idInElem >= 0 && idInElem != TestCompositeIdHuman::IdType(newId), "Objects not loaded in the right order!");
...
int TestCompositeIdContainer::EqualsOperatorCallerFromLua(lua_State *luaState) {
  auto instance = TestCompositeIdContainer::ReadProxyFromLua(luaState, -2);
  HOLGEN_WARN_AND_RETURN_IF(!instance, 0, "Calling TestCompositeIdContainer.operator== method with an invalid lua proxy object!");
  TestCompositeIdContainer arg0Mirror;
  TestCompositeIdContainer *arg0;
  if (lua_getmetatable(luaState, -1)) {
    lua_pop(luaState, 1);
    arg0 = TestCompositeIdContainer::ReadProxyFromLua(luaState, -1);
  } else {
    arg0Mirror = TestCompositeIdContainer::ReadMirrorFromLua(luaState, -1);
    arg0 = &arg0Mirror;
  }
...
void TestCompositeIdContainer::CreateLuaMetatable(lua_State *luaState) {
  ...
  lua_pushcfunction(luaState, TestCompositeIdContainer::EqualsOperatorCallerFromLua);
  lua_settable(luaState, -3);
